...
export default function CartScreen() {
  ...
  // Log para depuración: mostrar user, items y loading en cada render
  console.log('CartScreen render — user:', user?.id ? user.id : user, 'items.length:', items?.length, 'loading:', loading);
